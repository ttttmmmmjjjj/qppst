package com.hsic.tmj.pickerview;

import android.view.View;


import com.hsic.tmj.adapter.ArrayWheelAdapter;
import com.hsic.tmj.adapter.NumericWheelAdapter;
import com.hsic.tmj.listener.ISelectTimeCallback;
import com.hsic.tmj.listener.OnItemSelectedListener;
import com.hsic.tmj.provincewheelview.ProvinceWheelView;
import com.hsic.tmj.utils.ChinaDate;
import com.hsic.tmj.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private View view;
    private ProvinceWheelView wv_year;
    private ProvinceWheelView wv_month;
    private ProvinceWheelView wv_day;
    private ProvinceWheelView wv_hours;
    private ProvinceWheelView wv_minutes;
    private ProvinceWheelView wv_seconds;
    private int gravity;
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        // 年
        wv_year = (ProvinceWheelView) view.findViewById(R.id.year);
        ...
        // 月
        wv_month = (ProvinceWheelView) view.findViewById(R.id.month);
        ...
        // 日
        wv_day = (ProvinceWheelView) view.findViewById(R.id.day);
        ...
        wv_hours = (ProvinceWheelView) view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
        //wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);

        wv_minutes = (ProvinceWheelView) view.findViewById(R.id.min);
        ...
        wv_seconds = (ProvinceWheelView) view.findViewById(R.id.second);
    ...
    private void setChangedListener(ProvinceWheelView wheelView) {
        if (mSelectChangeCallback != null) {
...
//                maxItem = endD;
     ...
     * @param dividerType
     */
    public void setDividerType(ProvinceWheelView.DividerType dividerType) {
