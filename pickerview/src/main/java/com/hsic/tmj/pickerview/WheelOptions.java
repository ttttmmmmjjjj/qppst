...
public class WheelOptions<T> {
    private View view;
    private ProvinceWheelView wv_option1;
    private ProvinceWheelView wv_option2;
    private ProvinceWheelView wv_option3;
    ...
    public WheelOptions(View view, boolean isRestoreItem) {
        ...
        this.view = view;
        wv_option1 = (ProvinceWheelView) view.findViewById(R.id.options1);// 初始化时显示的数据
        wv_option2 = (ProvinceWheelView) view.findViewById(R.id.options2);
        wv_option3 = (ProvinceWheelView) view.findViewById(R.id.options3);
    }
