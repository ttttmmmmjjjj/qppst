package com.hsic.tmj.configure;
...
import com.hsic.tmj.pickerview.R;
...
public class PickerOptions {
    ...
    public ProvinceWheelView.DividerType dividerType = ProvinceWheelView.DividerType.FILL;//分隔线类型
