...
public class InfoDialog {
	 public enum Style{
	    ...
	    public static final int CANCELPOSITION = -1;//���ȡ����ť���� ��1��������ť��0��ʼ��
	    ...
	    private ViewGroup rootView;//AlertView �� ��View
	    private ViewGroup loAlertHeader;//����headerView
	    ...
	    public InfoDialog(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style,OnItemClickListener onItemClickListener){
...
//	        	tvAlertMsg.setGravity(Gravity.LEFT);
	    ...
	    protected void initListView(){
	        ...
	        alertButtonListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
	            ...
	            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
	                if(onItemClickListener != null)onItemClickListener.onItemClick(InfoDialog.this,position);
	                dismiss();
	            }
	        });
	    }
	    ...
	    protected void initAlertViews(LayoutInflater layoutInflater) {
	        ...
	        int position = 0;
	        //���������С�ڵ���HORIZONTAL_BUTTONS_MAXCOUNT�����Ǻ���button
	        if(mDatas.size()<=HORIZONTAL_BUTTONS_MAXCOUNT){
	            ...
	            for (int i = 0; i < mDatas.size(); i ++) {
	                ...
	                else if(i == mDatas.size() - 1){//�������ұߵİ�ťЧ��
	    ...
	    public InfoDialog addExtView(View extView){
	    ...
	    public InfoDialog setOnDismissListener(OnDismissListener onDismissListener) {
	    ...
	    /**
	     * ��Ҫ������չView��ʱ��������򣬼��̵���������MarginBottom���϶����������뷨��ס����
	     */
	    ...
	    public InfoDialog setCancelable(boolean isCancelable) {
