package com.hsic.tmj.provincewheelview;
...
import com.hsic.tmj.adapter.WheelAdapter;
import com.hsic.tmj.interfaces.IPickerViewData;
import com.hsic.tmj.listener.LoopViewGestureListener;
import com.hsic.tmj.listener.OnItemSelectedListener;
import com.hsic.tmj.timer.InertiaTimerTask;
import com.hsic.tmj.timer.MessageHandler;
import com.hsic.tmj.timer.SmoothScrollTimerTask;
import com.hsic.tmj.wheelview.R;
 ...
 * 3d滚轮控件
 */
public class ProvinceWheelView extends View {
    ...
    public ProvinceWheelView(Context context) {
        this(context, null);
    }

    public ProvinceWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
